...
| KI-016 | 2026-07-26 | Cold start แสดง system splash พื้นขาวและ Launcher icon ที่เส้นเชือกอ่านไม่ครบก่อนเข้า Home | Low | Fix awaiting verification | Starting activity ใช้ Light theme ที่ไม่มี splash attributes จึงให้ Android 12+ ใช้พื้นขาวและ adaptive Launcher icon ซึ่ง mask foreground ใกล้ขอบ | เพิ่ม branded starting theme, พื้น `#071426` และ splash logo แยกใน safe zone; รอ T-211 บน Samsung Galaxy S23 Ultra |
