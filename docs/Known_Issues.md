...
| KI-020 | 2026-07-29 | Continuous 100 Jumps ในแสงปกตินับได้ T-726 85/100, T-727 93/100, T-728 83/100 และ T-729 BASE 86/101 ต่ำกว่าเป้าหมาย 95%; T-730 V13 Formal ได้ 19/22 | High | Confirmed / V14 passive diagnosis prepared | Root cause ของ undercount ยังไม่ยืนยัน. T-729 แสดงว่า BIL `0.006` และ RES `0.018` แบบลดทีละ gate ไม่เพียงพอ. V13 Formal มี trace integrity ครบแต่ `WIN P19 C19 R0 S0 U0` จึงไม่พบ rejected WINDOW gate ที่อธิบาย physical misses 3 ครั้ง. Accepted spans `#015` 1,303ms และ `#019` 743ms สอดคล้องเชิงเวลากับ cycle merging hypothesis แต่ยังแยก Landing/re-arm/next-rise mechanism ไม่ได้ | คง BASE `0.010/0.020` และไม่แก้ `BasicBounceDetector`, threshold หรือ Counter. ใช้ V14 external collector เก็บ AIR frame samples, AIR/GAP/T2T, landing reason และ count interval; รัน tests/build และ Smoke ก่อน Formal ตาม `docs/T730_V14_Cycle_Separation_Trace.md`; วิเคราะห์วิดีโอและ overlay ก่อนเสนอ code change |
