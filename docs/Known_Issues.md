...
| KI-020 | 2026-07-29 | Continuous 100 Jumps ในแสงปกตินับได้ T-726 85/100, T-727 93/100 และ T-728 83/100 ต่ำกว่าเป้าหมาย 95%; T-727/T-728 ไม่สะดุดเชือก | High | Confirmed / Root-cause boundary narrowed | ทั้งสามรอบไม่ใช่ Landing, cooldown หรือ performance regression; T-728 ได้ `AIR/LAND 83/83`, `SUP 0`, rescue 79, FPS 29.6, LAT 25/46ms, IN/OUT 2572/2571 และ SKIP ~0. V11 ยืนยัน rejected peak แบบค่าเฉลี่ยสูงแต่ข้างหนึ่งตก individual floor: `R A0.027/0.029 H0.006/0.006 ... ANK`, `BIL L0.007 FAIL R0.051 PASS MIN0.010`. นอกจากนี้พบ rejected peak ที่ bilateral ผ่านทั้งคู่แต่ smoothed ankle rise อยู่ขอบ rescue floor: `R A0.019/0.020 H0.121/0.119 ... ANK`, `BIL L0.023 PASS R0.017 PASS MIN0.010`; ค่าที่แสดงปัดเศษสามตำแหน่งจึงยังบอก exact margin ต่อ `0.020` ไม่ได้. หลักฐานจึงไม่สนับสนุน root cause เดียว แต่ชี้สอง boundary คือ individual bilateral floor และ smoothed rescue floor; ค่า `ANK` เป็น diagnostic transitions ไม่ใช่จำนวน miss | T-728 ผ่านเป้าหมาย passive evidence แต่ Fail accuracy. ก่อนปรับ detector ให้เตรียม experiment ขนาดเล็กที่แยกสอง gate และเพิ่ม precision ของ passive evidence หากจำเป็น; การเปลี่ยน threshold/decision ต้องขออนุมัติ และต้องรัน heel raise, knee lift, standing และ short/continuous Basic Bounce controls |
