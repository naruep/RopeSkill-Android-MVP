...
| KI-020 | 2026-07-29 | Continuous 100 Jumps ในแสงปกตินับได้ T-726 85/100, T-727 93/100 และ T-728 83/100 ต่ำกว่าเป้าหมาย 95%; T-727/T-728 ไม่สะดุดเชือก | High | Confirmed / Experiment prepared | ทั้งสามรอบไม่ใช่ Landing, cooldown หรือ performance regression; T-728 ได้ `AIR/LAND 83/83`, `SUP 0`, rescue 79, FPS 29.6, LAT 25/46ms, IN/OUT 2572/2571 และ SKIP ~0. V11 พบ rejected peak แบบข้างหนึ่งตก individual floor (`L0.007/R0.051`) แต่ตัวอย่างนั้นมี hip `0.006` จึงไม่พิสูจน์ bilateral เป็นสาเหตุเดียว; clean boundary ที่ bilateral ผ่านแต่ smoothed ankle อยู่ขอบ rescue คือ `A0.019/0.020 H0.121/0.119`, `L0.023/R0.017`. หลักฐานจึงชี้สอง boundary ที่ต้องแยกทดลอง และค่า `ANK` เป็น diagnostic transitions ไม่ใช่จำนวน miss | T-729 เตรียม matched shadows บนเฟรมเดียวกัน: BASE `0.010/0.020`, exploratory BIL-only `0.006/0.020`, RES-only `0.010/0.018`; BASE เท่านั้นควบคุมแอป และต้องเริ่มในสถานะ `MATCHED`. ต้องรัน Unit tests/Build, smoke/performance, Continuous 100 Jumps และ controls โดย candidate ต้อง `95–100/100`, `D > 0`, controls ทุก arm `J0 A/L0/0 S0`. Shadow winner ยังต้องผ่าน active single-profile confirmation ก่อนเปลี่ยน baseline หรือปิด KI-020 |
