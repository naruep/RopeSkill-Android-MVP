...
| KI-020 | 2026-07-29 | Continuous 100 Jumps ในแสงปกตินับได้ T-726 85/100, T-727 93/100, T-728 83/100 และ T-729 BASE 86/101 ต่ำกว่าเป้าหมาย 95%; T-730 V13/V14 Formal ได้ 19/22 ขณะที่ V15 Formal ได้ 22/22 | High | Confirmed / V15 instrumentation validated; repeatability pending | V14 แยก misses เป็น 1 cycle ที่ไม่สร้าง proposal (`T2T 1027ms`, `GAP 862ms`) กับ 2 rejected proposals (`RA2`, หนึ่งร่วม `BR1`). V15 แสดง decomposition `E0` ได้ถูกต้อง แต่ Formal 22/22 มี `WIN R0` และไม่ทำซ้ำ anomaly จึงไม่มี margin row สำหรับเลือก gate fix. ความแตกต่าง 19/22 → 22/22 ยืนยันความแปรผันระหว่างรอบ ไม่ใช่หลักฐานว่า issue หาย | คง BASE `0.010/0.020` และไม่แก้ `BasicBounceDetector`, threshold หรือ Counter. รัน T-731 repeatability ด้วย commit/APK/แสง/จังหวะเดิม; ใช้ V15 signed margins/`LONG` เฉพาะเมื่อ failure pattern เกิดซ้ำ แล้วเลือก production experiment ทีละสาเหตุจากหลักฐานหลายรอบ |
