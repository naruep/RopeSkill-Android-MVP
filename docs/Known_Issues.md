...
| KI-022 | 2026-07-31 | Basic Bounce ภายใต้เงื่อนไขเดิมแปรผันจาก `21/22` เป็น `15/22`, `18/22` และ T-741 cadence-controlled `18/22`; changed-clothing ได้ `18/22` | High | Confirmed | T-742 ยืนยัน mixed cycle-level signatures: READY gate rejection 10/20, physical pulse ขณะ production ยัง AIR 9/20 และ unqualified/uncertain proposal 1/20. ยังไม่ทราบ Landing operand/phase cause ของ AIR group และไม่มี clothing-specific pattern | ทำ T-743 bounded debug-only passive Landing/State trace เพื่อเก็บ returned-to-baseline, descent, next-rise, timeout และ close/reset reason; ห้ามปรับ takeoff threshold, Landing หรือ detector behavior ในขั้นนี้ |
