...
| KI-020 | 2026-07-29 | Continuous 100 Jumps ในแสงปกตินับได้ T-726 85/100, T-727 93/100, T-728 83/100 และ T-729 BASE 86/101 ต่ำกว่าเป้าหมาย 95%; T-730 V13/V14 Formal ได้ 19/22, V15 22/22, T-731 18/22, T-732 19/22 และ T-733 Formal สองรอบ 21/22 | High | Confirmed / RA variability plus proposal-cycle miss | V14 แยกเป็น proposal/cycle miss 1 + gate rejection 2; T-731/T-732 แสดง RA variability แต่ T-733 matched `RA 0.016/0.015` ไม่กู้ miss ทั้งสอง Formal (`D+0`) แม้ controls ทุก arm เป็น 0. Undercount ล่าสุดจึงไม่รองรับการลด RA และยังต้องแยกว่า motion pulse เกิดระหว่าง BASE `AIRBORNE` หรือไม่สร้าง proposal ใน `GROUNDED` | คง production BASE `0.010/0.020`. ใช้ T-734 Debug-only passive pulse trace แยก qualified motion pulse ที่ matched/unmatched กับ production Takeoff และทำ video correlation; ขออนุมัติชัดแจ้งก่อนแก้ `BasicBounceDetector`, state machine หรือ threshold |
