...
| KI-020 | 2026-07-29 | Continuous 100 Jumps ในแสงปกตินับต่ำกว่าเป้าหมาย; T-737 Formal Repeat ได้ 21/22 หลัง Formal 22/22 | High | T-738 candidate prepared / awaiting device verification | T-736/T-737 แก้ RA boundary และ timeout Landing แล้ว; Repeat ล่าสุดขาดจาก isolated `BR` ก่อน Takeoff ที่ `L0.069/R0.005/H0.145`, ขณะที่ accepted `T/L21/21`, `UA0`, `X0`, `SUP0` | T-738 เพิ่ม bounded asymmetric rescue strong/weak ankle `0.060/0.004` และ hip `0.120` โดยไม่ลด bilateral `0.008` แบบกว้าง; ต้องผ่าน Windows tests/build, Smoke, Safety Controls และ Formal 22/22 สองรอบก่อนปิด issue |
