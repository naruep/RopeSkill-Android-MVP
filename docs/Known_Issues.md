...
| KI-016 | 2026-07-26 | Cold start เดิมแสดงพื้นขาว; หลังเพิ่ม branded splash โลโก้ยังใหญ่และ system mask ตัดศีรษะกับห่วงเชือก | Low | Fix awaiting verification | Starting activity เดิมไม่มี splash attributes; รอบ 224dp ถึง 136dp ถูก mask มากขึ้นตามขนาด ส่วนรอบ 128dp ยังตัดยอดวงเชือกราว 1px จากการปัดเศษขอบ mask | คง canvas 288dp และพื้น `#071426` แต่ลดภาพภายในเป็น 124dp เพื่อเพิ่ม margin ประมาณ 3px โดยทุกส่วนอื่นผ่านแล้ว; รอ T-211 รอบยืนยันบน Samsung Galaxy S23 Ultra |
