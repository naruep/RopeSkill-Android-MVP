...
| KI-020 | 2026-07-29 | Continuous 100 Jumps ในแสงปกตินับได้ T-726 85/100, T-727 93/100, T-728 83/100 และ T-729 BASE 86/101 ต่ำกว่าเป้าหมาย 95%; T-730 V13/V14 Formal ได้ 19/22, V15 22/22, T-731 18/22, T-732 19/22 และ T-733/T-734 Formal สองรอบ 21/22 | High | Confirmed / RA variability plus grounded proposal-gate miss | V14 แยก proposal/cycle miss 1 + gate rejection 2; T-731/T-732 แสดง RA variability แต่ T-733 candidates ไม่กู้ miss (`D+0`). T-734 Formal สองรอบเห็น `Q22 M21 U1 UA0` และ `QU ... READY` ซ้ำ จึงจำกัด miss ล่าสุดเป็น grounded production proposal/gate path ไม่ใช่ AIRBORNE lock | คง production BASE `0.010/0.020`. ใช้ T-735 Debug-only จับคู่ `QU` กับ production rejected peak และ exact gate blockers หรือระบุ `NP`; ขออนุมัติชัดแจ้งก่อนแก้ `BasicBounceDetector`, state machine หรือ threshold |
