...
| KI-018 | 2026-07-28 | Basic Bounce บน APK ปัจจุบันนับขาดในแสงสลัว: T-721 ได้ 20/20, 19/20 และ 17/20 รวม 56/60 | High | Open | การนับที่รับแล้วมี `AIR=LAND`, `SUP 0` และ trace ไม่มี `LS` หรือ Landing cycle แตกซ้ำ จึงไม่ใช่ regression ของ KI-013; T-722 ที่ commit `20e55fe` ได้แสงปกติ 20/20 ที่ FPS 30.0 และแสงสลัว 19/20 ที่ FPS 25.0 โดย genuine miss เป็น trace `#46 R A0.020 H0.141 ANK` และ V10 `R A0.020/0.023 H0.141/0.157 F7 D240 P39 N42 ANK`; T-723 ที่ commit `70e35e7` ลด rescue floor เป็น `0.020` และผ่าน safety controls แต่ได้แสงสลัว 19/20 เท่า T-722 และ normal-light sanity 18/20; ทั้งสองรอบ `AIR=LAND`, `SUP 0` และ performance ปกติ จึงไม่พบ Landing regression แต่ยังไม่ยืนยัน accuracy improvement อย่างสม่ำเสมอ | คง floor `0.020` และ guard อื่นเดิมไว้ระหว่างเก็บ repeatability evidence เพิ่มเติม; ห้ามลด standard threshold, hip gate, bilateral/sync, cooldown หรือ Landing re-arm guard โดยไม่มีการอนุมัติ และยังไม่ปิด KI-018 |
