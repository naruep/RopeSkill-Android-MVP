...
| KI-020 | 2026-07-29 | Continuous 100 Jumps ในแสงปกตินับได้ T-726 85/100, T-727 93/100, T-728 83/100 และ T-729 BASE 86/101 ต่ำกว่าเป้าหมาย 95%; T-735 Formal ได้ 19/22 | High | Fix prepared / awaiting device verification | T-735 ระบุ genuine misses ขณะ `READY` เป็น rescue ankle `RA ×2` ที่ `P0.017/0.019` และ bilateral right `BR ×1` ที่ค่าจริงชิดต่ำกว่า `0.010`; ไม่ใช่ AIRBORNE lock และ Takeoff/Landing สมดุล | T-736 candidate ใช้ bilateral `0.008` และ rescue ankle `0.016` โดยคง RH `0.100` กับ logic อื่น; offline 97/97 ผ่าน. ต้องผ่าน Windows build, Smoke และ false-positive controls ก่อน Formal/ปิด issue |
