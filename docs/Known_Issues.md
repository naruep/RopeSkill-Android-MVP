...
| KI-020 | 2026-07-29 | Continuous 100 Jumps ในแสงปกตินับได้ T-726 85/100, T-727 93/100, T-728 83/100 และ T-729 BASE 86/101 ต่ำกว่าเป้าหมาย 95%; T-730 V13/V14 Formal ได้ 19/22, V15 Formal 22/22 และ T-731 Round 1 18/22 | High | Confirmed / gate variability reproduced | V14 แยก misses เป็น 1 cycle miss กับ 2 gate rejections; V15 Formal ไม่เกิด miss; T-731 สร้าง proposals ครบ 22 แต่ rejected 4 โดย RA เกี่ยวข้องทั้งหมด. สองรายการเป็น RA-only (`RA -0.0039/-0.0005`) และอีกสองรายการติด bilateral ร่วม (`BL/BR/RA`, `BR/RA`) จึงลด RA อย่างเดียวไม่กู้คืนครบ 4 | คง BASE `0.010/0.020` และไม่แก้ `BasicBounceDetector`, threshold หรือ Counter. ใช้ T-732 V16 แยก RA-only และคำนวณ recovery bounds จาก operands จริง; active candidate ต้องเลือกจากหลักฐานหลายรอบและผ่าน false-positive controls ก่อน |
