...
| KI-013 | 2026-07-25 | Basic Bounce อาจต่ำกว่าเป้าหมายแม้ repeatability รอบก่อนผ่าน | High | Reopened | ลด Strong-Hip Rescue ankle floor จาก `0.030` เป็น `0.025` แล้ว T-715/T-716 ผ่าน แต่ T-717 แสงปกติได้ 17/20 และ 15/20; rejected genuine-looking takeoff มี ankle `0.021–0.024` ต่ำกว่า floor เล็กน้อยแม้ hip `0.125–0.165`; รอบแสงน้อยได้ 19/20 จึงยังระบุแสงเป็นสาเหตุไม่ได้ | ตรวจ event timing, rejected evidence และ cooldown suppression จากโค้ด/วิดีโอโดยไม่แก้ `BasicBounceDetector`; ออกแบบ controlled confirmation ก่อนเสนอ threshold หรือ state-machine change และต้องได้รับความเห็นชอบอย่างชัดเจนก่อนแก้ detector |
