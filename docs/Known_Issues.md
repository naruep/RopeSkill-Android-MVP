...
| KI-020 | 2026-07-29 | Continuous 100 Jumps ในแสงปกตินับได้ T-726 85/100, T-727 93/100, T-728 83/100 และ T-729 BASE 86/101 ต่ำกว่าเป้าหมาย 95%; T-730 V13/V14 Formal ได้ 19/22, V15 22/22, T-731 18/22 และ T-732 19/22 | High | Confirmed / RA variability plus proposal miss | V14 แยกเป็น proposal/cycle miss 1 + gate rejection 2; T-731 มี proposals ครบแต่ rejected 4 โดย RA เกี่ยวข้องทั้งหมด; T-732 มี proposal miss 1 + RA-only 2 ที่ operands `0.0153/0.0151`. RA change อาจกู้บาง proposals แต่ไม่แก้ proposal miss และยังไม่ทราบ false-positive risk | คง production BASE `0.010/0.020`. ใช้ T-733 matched shadows `RA 0.016/0.015` กับ Basic Bounce และ heel raise/knee lift/standing controls; reject candidate ที่เกิด false positive และขออนุมัติชัดแจ้งก่อนแก้ `BasicBounceDetector` หรือ threshold |
