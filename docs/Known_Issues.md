...
| KI-016 | 2026-07-26 | Cold start เดิมแสดงพื้นขาว; หลังเพิ่ม branded splash โลโก้ยังใหญ่และ system mask ตัดศีรษะกับห่วงเชือก | Low | Fix awaiting verification | Starting activity เดิมไม่มี splash attributes; รอบแก้แรกวางภาพในกรอบ 224dp ซึ่งเกิน safe area 192dp ของ system splash | คง canvas 288dp และพื้น `#071426` แต่ลดภาพภายในเป็น 192dp; รอ T-211 รอบยืนยันบน Samsung Galaxy S23 Ultra |
