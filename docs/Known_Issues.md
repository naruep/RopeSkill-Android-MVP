...
| KI-016 | 2026-07-26 | Cold start เดิมแสดงพื้นขาว; หลังเพิ่ม branded splash โลโก้ยังใหญ่และ system mask ตัดศีรษะกับห่วงเชือก | Low | Fix awaiting verification | Starting activity เดิมไม่มี splash attributes; รอบ 224dp และ 192dp ถูก mask มาก ส่วนรอบ 136dp ยังตัดเฉพาะยอดห่วงเชือกเพราะ artwork radius ประมาณ 113.9px เกินขอบ mask ที่วัดได้ 109–111px | คง canvas 288dp และพื้น `#071426` แต่ลดภาพภายในเป็น 128dp ซึ่งคาดว่าให้ artwork radius ประมาณ 107.2px และมี margin เล็กน้อย; รอ T-211 รอบยืนยันบน Samsung Galaxy S23 Ultra |
