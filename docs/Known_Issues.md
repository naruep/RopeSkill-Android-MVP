...
| KI-016 | 2026-07-26 | Cold start เดิมแสดงพื้นขาว; หลังเพิ่ม branded splash โลโก้ยังใหญ่และ system mask ตัดศีรษะกับห่วงเชือก | Low | Fix awaiting verification | Starting activity เดิมไม่มี splash attributes; รอบ 224dp ถูก mask มาก และรอบ 192dp ยังตัดห่วงเชือกด้านบน แสดงว่าการใช้ safe-area diameter เป็นขนาดกรอบภาพโดยตรงไม่เผื่อรูปทรงจริงของ asset | คง canvas 288dp และพื้น `#071426` แต่ลดภาพภายในเป็น 136dp ซึ่งต่ำกว่าขนาดชนขอบที่คำนวณจากวิดีโอประมาณ 141dp; รอ T-211 รอบยืนยันบน Samsung Galaxy S23 Ultra |
