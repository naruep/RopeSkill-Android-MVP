...
| KI-020 | 2026-07-29 | Continuous 100 Jumps ในแสงปกตินับได้ T-726 85/100, T-727 93/100, T-728 83/100 และ T-729 BASE 86/101 ต่ำกว่าเป้าหมาย 95%; T-730 V13/V14 Formal ได้ 19/22 | High | Confirmed / V15 passive diagnosis prepared | V14 Formal มี trace integrity ครบและแยก physical misses 3 ครั้งเป็น 1 cycle ที่ไม่สร้าง proposal (`T2T 1027ms`, `GAP 862ms`) กับ 2 rejected proposals (`RA2`, หนึ่งรายการร่วม `BR1`). ยังไม่ทราบ numeric distance จากแต่ละ gate threshold และ longest T2T delay อยู่ใน AIR หรือ re-arm phase มากเท่าใด จึงยังไม่เลือก production fix | คง BASE `0.010/0.020` และไม่แก้ `BasicBounceDetector`, threshold หรือ Counter. ใช้ V15 external collector แสดง signed gate margins จาก exact operands และ longest T2T decomposition; รัน regression/build และ Smoke ก่อน Formal ตาม `docs/T730_V15_Rejection_Cycle_Miss_Trace.md`; เลือก production experiment ทีละสาเหตุหลังวิเคราะห์วิดีโอ |
