...
| KI-020 | 2026-07-29 | Continuous 100 Jumps ในแสงปกตินับได้ T-726 85/100, T-727 93/100, T-728 83/100 และ T-729 BASE 86/101 ต่ำกว่าเป้าหมาย 95%; รอบที่ไม่มี rope trip ยังเกิดซ้ำ | High | Confirmed / T-729 no promotion candidate | T-729 เริ่มและจบใน matched window โดย BASE `J86 A/L86/86 S0 RES81` ตรงกับ App/Result; BIL-only `J86 D+0` ส่วน RES-only `J88 A/L88/88 S0 RES83 D+2`. หลัง Landing สุดท้าย Counter ไม่เพิ่ม และ performance/stability ผ่าน. ผลนี้ตัดเฉพาะ BIL `0.006` และ RES `0.018` แบบลดทีละ gateออกจากการเป็น fix ที่เพียงพอ; RES boundary มีส่วนสุทธิ 2 counts แต่ไม่ได้พิสูจน์ว่า gate ทั้งสองไม่เกี่ยวข้องกับ miss อื่น หรือครอบคลุมกรณีที่หลาย gate fail พร้อมกัน | ยุติ T-729 ก่อน controls/active confirmation เพราะไม่มี candidate ถึง efficacy gate; ไม่ถือว่า safety controls ผ่าน. คง BASE `0.010/0.020` และ KI-020 เปิดไว้ จากนั้นวิเคราะห์ rejected evidence เพื่อออกแบบ passive/controlled step ถัดไปก่อนเปลี่ยน `BasicBounceDetector`; หากนำ RES `0.018` กลับมาใช้ต้องรัน controls ใหม่ |
