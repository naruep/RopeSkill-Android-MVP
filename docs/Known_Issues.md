...
| KI-022 | 2026-07-31 | Basic Bounce ภายใต้เงื่อนไขและสีกางเกงเดิมแปรผันจาก `21/22` เป็น `15/22` และ `18/22`; เปลี่ยนกางเกงแล้วได้ `18/22` | High | Investigating | ยังไม่ยืนยัน; diagnostics ในวิดีโอมี `ANKLE RISE TOO SMALL`, `FEET NOT SYNCHRONIZED` และบางช่วง `HIP RISE TOO SMALL`, ขณะที่ `T/L`, `SUP`, performance และ stability ปกติ | รัน T-741 cadence-controlled repeatability สูงสุด 2 รอบโดยคงตัวแปรทั้งหมด; หยุดหลังรอบแรกหากต่ำกว่า `21/22`; ห้ามแก้ threshold หรือ detector ก่อนวิเคราะห์หลักฐาน |
