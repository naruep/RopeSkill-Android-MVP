...
| KI-017 | 2026-07-26 | วงเชือกใน Adaptive App Icon อยู่ใกล้ขอบ Launcher mask มากกว่ามุมมอง Cold Start | Low | Fix awaiting verification | foreground inset 10dp เหลือกรอบภาพ 88dp ทำให้ขอบเขตรัศมีของ asset ประมาณ 73.6dp เกิน safe zone 66dp ของ Adaptive Icon | เพิ่ม foreground inset เป็น 16dp ทำให้ขอบเขต artwork ประมาณ 63.6dp; ใช้ drawable เดียวกันกับ monochrome และรอ T-212 บน Samsung Galaxy S23 Ultra |
