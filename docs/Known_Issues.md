...
| KI-009 | 2026-07-24 | หลัง Pause/Resume บางรอบ Counter ไม่เพิ่มและ diagnostic ค้าง `AIRBORNE` | High | Fix awaiting verification | วิดีโอทำซ้ำได้และ source ยืนยันว่า state `AIRBORNE` เดิมไม่มีทางออกหาก ankle landmark ไม่กลับเข้า landing band | ถ้ายังไม่พบ Landing ภายใน 1.5 วินาที ให้ยกเลิก Takeoff นั้นโดยไม่เพิ่ม Counter และเริ่ม calibration ใหม่; ไม่เปลี่ยน takeoff/landing/cooldown thresholds เดิม; รอทดสอบบนอุปกรณ์จริง |
