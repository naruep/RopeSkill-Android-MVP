...
- **Status:** Accepted for testing / Android verification pending
...
- **Validation:** Pure-Kotlin compile/regression ผ่าน 77/77 ครอบคลุม production detector, T-729 parity และ V13 real-detector/timestamp/window/region/capacity/integrity/sealed-exit tests. Android Gradle tests, Build และ Samsung Galaxy S23 Ultra smoke/formal verification ยังรอดำเนินการ
...
- **Revisit when:** V13 smoke ยืนยัน timestamp/region/invalid reason, raw trace capacity และ BASE isolation บนอุปกรณ์จริงแล้ว จึงรัน formal counted-bookend 22-jump protocol; หาก `WINDOW` ยังรวม standing noise มาก, accepted anchors ไม่เสถียร, trace overflow หรือ event sequence invalid ให้แก้ instrumentation ก่อนตีความ KI-020
