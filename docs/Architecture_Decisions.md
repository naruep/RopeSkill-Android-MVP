...
- **Decision:** ใช้ AndroidX Core SplashScreen `1.2.0` กับ starting theme พื้น `#071426`; แสดง PNG โลโก้เดิมผ่าน drawable canvas 288dp โดยจำกัดภาพไว้ที่ 128dp เพื่อให้ขอบเขตจริงของคนและห่วงเชือกมี margin ภายใน system mask จากนั้นเปลี่ยนเข้า `Theme.RopeSkill` ทันทีโดยไม่ตั้ง delay
