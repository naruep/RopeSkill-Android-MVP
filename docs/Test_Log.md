...
| T-513 | Three-count evidence history | ทดสอบ Slow, Medium, Fast, Left knee lift และ Right knee lift แยก session ละ 3 counts แล้วอ่าน `COUNT HISTORY V3` | แสดงหลักฐาน 3 ครั้งล่าสุดเฉพาะครั้งที่ Counter เพิ่ม ล้างเมื่อ Start/Resume/Reset และไม่เปลี่ยน detector | รอ Build และทดสอบบน Samsung Galaxy S23 Ultra | Not Run |
