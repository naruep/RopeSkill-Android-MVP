...
| T-211 | Branded system splash | รัน unit tests/Build; force-stop แล้วเปิดจาก Launcher; เปิดซ้ำแบบ warm start; ทดสอบ Dark, Light และ System theme; ตรวจ Launcher icon, splash และ Home | ไม่มีพื้นขาว; splash พื้น `#071426`; คนและเชือกเห็นครบโดยไม่มี adaptive-icon frame ซ้อน; ไม่มี delay เพิ่ม; Home/Launcher icon เดิมและทุก theme เปิดถูกต้อง | ผู้ใช้ยืนยันว่าทุกกรณีผ่าน ยกเว้นขนาดโลโก้; รอบ 224dp ถูกตัดทั้งศีรษะและห่วงเชือก ส่วนวิดีโอ `Screen_Recording_20260726_122223_One UI Home.mp4` ของรอบ 192dp แสดงศีรษะแล้วแต่ห่วงเชือกด้านบนยังถูก mask ตัด เหลือเฉพาะปลายใกล้มือ จึงลดภาพเป็น 136dp ตามสัดส่วน crop พร้อม margin และรอทดสอบซ้ำ | Partial Pass |
