...
| T-211 | Branded system splash | รัน unit tests/Build; force-stop แล้วเปิดจาก Launcher; เปิดซ้ำแบบ warm start; ทดสอบ Dark, Light และ System theme; ตรวจ Launcher icon, splash และ Home | ไม่มีพื้นขาว; splash พื้น `#071426`; คนและเชือกเห็นครบโดยไม่มี adaptive-icon frame ซ้อน; ไม่มี delay เพิ่ม; Home/Launcher icon เดิมและทุก theme เปิดถูกต้อง | ผู้ใช้ยืนยันว่าทุกกรณีผ่าน ยกเว้นขนาดโลโก้; รอบ 224dp และ 192dp ถูก mask มาก ส่วนภาพ `Screenshot 2026-07-26 123935.png` ของรอบ 136dp แสดงตัวคนและเชือกด้านข้างครบ แต่ยอดห่วงเชือกยังอยู่นอกวงกลม การวัดได้ artwork radius ประมาณ 113.9px เทียบ mask 109–111px จึงลดอีกเล็กน้อยเป็น 128dp และรอทดสอบซ้ำ | Partial Pass |
