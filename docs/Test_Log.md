...
| T-212 | Adaptive launcher icon spacing | ติดตั้ง build ใหม่; ตรวจไอคอนปกติและ themed icon บน Launcher รวมวงกลมและ mask รูปแบบอื่นถ้ามี | คนและวงเชือกอยู่ภายใน mask โดยมี margin ใกล้เคียง Cold Start; รายละเอียดยังอ่านได้; ชื่อแอป, Home logo และ splash ไม่เปลี่ยน | ภาพ `Screenshot 2026-07-26 124639(1).png` แสดงวงเชือกของ inset 10dp อยู่ใกล้ขอบ; ปรับ foreground/monochrome เป็น inset 16dp ให้ขอบเขต artwork ประมาณ 63.6dp อยู่ใน safe zone 66dp; รอทดสอบบน Samsung Galaxy S23 Ultra | Not Run |
