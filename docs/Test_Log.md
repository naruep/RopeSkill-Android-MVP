...
Milestone 0–7 ผ่านส่วนหลักบน Samsung Galaxy S23 Ultra แล้ว T-716 ที่ detector baseline commit `591b938` และ Music OFF ผ่าน 59/60 หรือ 98.3% แต่ T-717 ที่ commit `7c247eb` พบความแปรผันด้านความแม่นยำเมื่อทดสอบแสง: แสงปกติได้ 17/20 และ 15/20 ส่วนแสงน้อยลงเล็กน้อยได้ 19/20; performance ปกติ, AIR=LAND, หลัง Pause ไม่เพิ่ม, ไม่พบ crash/freeze, AIRBORNE ค้าง หรือ preview กระตุก
