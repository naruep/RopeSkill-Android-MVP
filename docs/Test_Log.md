...
| T-208 | Theme preference | เลือก System default, Dark และ Light จาก Settings แล้วตรวจ Home/Settings/Result/Training รวมปิดและเปิดแอปใหม่ | Theme เปลี่ยนทันทีและคงอยู่; Home/Settings/Result ใช้ theme ที่เลือก; Training คง Dark; ข้อความ โลโก้ และปุ่มอ่านได้ชัด | รอ Build และทดสอบบน Samsung Galaxy S23 Ultra | Not Run |
