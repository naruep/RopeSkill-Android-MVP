...
| T-702 | MediaPipe performance baseline | เปิด Training ให้เห็นร่างกายครบและบันทึก `PERF V1` หลังทำงานต่อเนื่อง 30, 60 และ 120 วินาที | รายงาน result FPS, average/max inference latency, IN/OUT และ estimated SKIP โดยไม่เปลี่ยน detector; แอปไม่ค้างและตัวเลขอัปเดตไม่เกินหนึ่งครั้งต่อวินาที | รอบ 30 วินาที: 30.0 FPS, 32/193ms, IN 988, OUT 982, SKIP~5; รอบ 60 วินาที: 30.0 FPS, 34/193ms, IN 2409, OUT 2395, SKIP~13; ภาพ 120 วินาทีเป็น tracker รอบใหม่: 25.3 FPS, 34/193ms, IN 1617, OUT 1604, SKIP~12 จึงยังต้องทดสอบ 120 วินาทีต่อเนื่องซ้ำ | Partial Pass |
| T-703 | Auto-pause on tracking loss | ระหว่าง Running เดินออกจากเฟรมเกิน 1 วินาที แล้วกลับเข้ากล้อง | Timer หยุด, สถานะเป็น Paused และปุ่มเป็น Resume; กด Resume แล้วผ่าน Positioning/Countdown ก่อนนับต่อ; landmark สะดุดสั้นกว่า 1 วินาทีไม่ทำให้ Pause | รอ Build และทดสอบบนอุปกรณ์จริง | Not Run |
