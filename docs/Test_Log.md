...
| T-211 | Branded system splash | รัน unit tests/Build; force-stop แล้วเปิดจาก Launcher; เปิดซ้ำแบบ warm start; ทดสอบ Dark, Light และ System theme; ตรวจ Launcher icon, splash และ Home | ไม่มีพื้นขาว; splash พื้น `#071426`; คนและเชือกเห็นครบโดยไม่มี adaptive-icon frame ซ้อน; ไม่มี delay เพิ่ม; Home/Launcher icon เดิมและทุก theme เปิดถูกต้อง | ผู้ใช้ยืนยันว่าทุกกรณีผ่าน ยกเว้น splash logo ใหญ่เกินไป; วิดีโอ `Screen_Recording_20260726_115300.mp4` ยืนยันว่า system mask ตัดส่วนศีรษะและห่วงเชือก จึงลดกรอบภาพภายในจาก 224dp เป็น safe area 192dp และรอทดสอบซ้ำ | Partial Pass |
