...
| T-211 | Branded system splash | รัน unit tests/Build; force-stop แล้วเปิดจาก Launcher; เปิดซ้ำแบบ warm start; ทดสอบ Dark, Light และ System theme; ตรวจ Launcher icon, splash และ Home | ไม่มีพื้นขาว; splash พื้น `#071426`; คนและเชือกเห็นครบโดยไม่มี adaptive-icon frame ซ้อน; ไม่มี delay เพิ่ม; Home/Launcher icon เดิมและทุก theme เปิดถูกต้อง | เพิ่ม AndroidX splash starting theme และ safe-zone drawable แล้ว; รอทดสอบบน Samsung Galaxy S23 Ultra | Not Run |
