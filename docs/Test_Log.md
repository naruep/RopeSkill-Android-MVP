...
| T-705 | Continuous jump-rope cadence | กระโดด Basic Bounce ต่อเนื่อง 20 ครั้งที่ประมาณ 125–140 jumps/min ตามจังหวะวิดีโอ `Screen_Recording_20260724_202318.mp4` | นับอย่างน้อย 18/20, `AIRBORNE` ไม่ค้างข้ามหลายรอบ, ไม่เพิ่มเองหลังหยุด และ Result/History ตรงกัน | รอบอุปกรณ์จริงนับ 11/20, false count หลังหยุด 0; วิดีโอแสดง `AIR 11 / LAND 11` จึงไม่พบ stuck-airborne ในรอบนี้ แต่ `ANK 11 / HIP 1 / SYNC 1` และหลักฐาน Count ที่ ankle-rise 0.045–0.055 ชี้ว่ารอบที่พลาดน่าจะถูกปฏิเสธก่อน Takeoff; FPS 29.9, IN/OUT 849/848, SKIP~0 | Fail |
| T-706 | Rejected Takeoff Evidence V5 | กระโดดเชือกต่อเนื่อง 20 ครั้งที่ cadence เดิม แล้วอ่าน `REJECTED TAKEOFF V5` หลังหยุด | แสดง 3 rejected cycles ที่มี ankle-rise สูงสุด พร้อมค่าจริง/threshold ของ ankle, hip, hip-to-ankle ratio, synchronization และเหตุผล โดย Counter/threshold/state machine ไม่เปลี่ยน | เพิ่ม passive diagnostic และ unit tests แล้ว; ไม่บันทึก pose/camera data; Gradle workspace ดาวน์โหลด distribution ไม่ได้ จึงรอ Build/unit test และทดสอบบน Samsung Galaxy S23 Ultra | Not Run |
