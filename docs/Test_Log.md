...
| T-705 | Continuous jump-rope cadence | กระโดด Basic Bounce ต่อเนื่อง 20 ครั้งที่ประมาณ 125–140 jumps/min ตามจังหวะวิดีโอ `Screen_Recording_20260724_202318.mp4` | นับอย่างน้อย 18/20, `AIRBORNE` ไม่ค้างข้ามหลายรอบ, ไม่เพิ่มเองหลังหยุด และ Result/History ตรงกัน | วิดีโอ baseline มีอย่างน้อยประมาณ 18 รอบขึ้น–ลงที่เห็นชัด แต่แอปนับ 3; เพิ่มการจบ cycle จากขึ้น→ลง→เริ่มขึ้นรอบถัดไปและ regression simulation ได้ 20/20 โดยไม่เปลี่ยน detector thresholds; Gradle workspace ดาวน์โหลด distribution ไม่ได้ จึงรอ unit test และอุปกรณ์จริง | Not Run |
