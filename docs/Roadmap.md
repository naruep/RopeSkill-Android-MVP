...
- [x] สร้าง Counter (รอทดสอบบนอุปกรณ์)
- [x] สร้างปุ่ม Start, Pause และ Finish (รอทดสอบบนอุปกรณ์)
- [x] สร้าง Timer ที่หยุดเมื่อแอปออกจาก foreground (รอทดสอบบนอุปกรณ์)
- [x] แยก UI state ไปยัง ViewModel และ StateFlow (รอทดสอบบนอุปกรณ์)
