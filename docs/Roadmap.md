...
- [x] เพิ่ม ready-position check, countdown 5 วินาที และเริ่ม Timer จาก Takeoff แรก (ทดสอบผ่านส่วนหลัก)
...
- [x] ให้ `START TRAINING` เปิด Ready Detection อัตโนมัติและคงเฉพาะ `RESUME` หลัง Pause (Single Start ผ่าน; Resume รอยืนยัน)
- [x] ทดสอบ stability check รอบสองและยืนยันว่าไวเกินไป
- [x] ทดสอบ detector รอบสองและยืนยันการถดถอย fast 1/10, slow/medium 0/10
- [x] คืน detector/Countdown behavior รอบแรกและเพิ่ม diagnostic overlay (รอทดสอบ)
- [ ] ทดสอบ detector ที่คืนค่าและ Resume บนอุปกรณ์จริง
