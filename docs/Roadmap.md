...
- [x] ให้ `START TRAINING` เปิด Ready Detection อัตโนมัติและคงเฉพาะ `RESUME` หลัง Pause (รอทดสอบ)
- [x] เพิ่ม stability check เพื่อยกเลิก Countdown ตลอดช่วง 5–1 (รอทดสอบ)
- [x] ปรับ detector รอบสองสำหรับ fast jump, knee bend และ small step (รอทดสอบ)
