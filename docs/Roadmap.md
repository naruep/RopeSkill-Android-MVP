...
- [ ] รัน Unit tests/Build และ T-729 บน Samsung Galaxy S23 Ultra: ต้องเห็น `MATCHED`, ไม่มี `WARM`, ทุก arm `J0` ก่อนเริ่ม; ผ่าน smoke/performance check แล้วจึง Continuous 100 Jumps, heel raise 20, knee lift ซ้าย/ขวาข้างละ 5, standing และหลังหยุด 15 วินาที. Candidate ต้องได้ `95–100/100`, `D > 0`, controls ทุก arm `J0 A/L0/0 S0`, หลังหยุด `A=L`, `SUP 0` และ stability ผ่านก่อน active confirmation; หยุดก่อนครบ 100 หาก overlay invalid, BASE ไม่ตรงแอป หรือ performance/stability ถดถอย
